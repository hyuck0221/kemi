...
import com.hshim.kemi.model.ChatMessage
import com.hshim.kemi.model.ChatSessionState
import com.hshim.kemi.model.GeminiChatRequest
...
class GeminiChatGenerator(
    ...
    class ChatSession(
        ...
        private fun directSendMessageStream(handler: StreamResponseHandler): String? {
            val url = generateContentUrl(currentModel, currentApiKey).replace("generateContent", "streamGenerateContent")
            val requestBody = GeminiChatRequest.fromHistory(history, defaultPrompt, systemPrompt)
